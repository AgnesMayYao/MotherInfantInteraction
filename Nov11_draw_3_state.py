...
if __name__ == '__main__':
    ...
    results=[]
    result_file_name="timestamp_Nov11.csv"
    ...
    for i in range(0,2):
        ...
        if i==0:
            ...
            acc.text(data_time[len(data_time)-1], data_acc[len(data_acc)-1]-1, "baby", fontsize=small_font_size, color='green')
    ...
    #elan file     
    elan_filename="three states _ p1 nov 11 home visit pickup-putdown.txt"
    ...
    row_no=1
    ##starting_unix=1478890462020
    #offset=1478890462020
    offset=1478890442020
    counter=0
    elan.set_ylim([-1,4])
    labels = [item for item in elan.get_yticklabels()]
    #labels[1]='nearby'
    #labels[2]='putting down'
    #labels[3]='holding still'
    #labels[4]='holding walking'
    #labels[5]='picking up'
    #labels[6]='hovering'
    #label=['nearby','putting down','holding still','holding walking','picking up','hovering']
    label=[]
    ...
    plt.title('Nov 11',fontsize=large_font_size)
